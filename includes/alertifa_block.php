            ...
            <div class="ui eight wide column" id="sticky-alert-stop">
                <div class="ui raised text blue segment inverted">
                    <h2 class="ui header centered inverted">
                        <a class="ui header centered inverted popup-img" target="_blank" href="http://www.famibelle-pronzola.website/alertifa" data-tooltip="Cliquez pour ouvrir">Alert'IFA</a>
                        <em class="sub header inverted">Outil permettant l’amélioration de la communication entre l’administration et les stagiaires, au sein d'un centre de formation.</em>
                    </h2>
                </div>
                <div class="ui padded stackable two column center aligned grid segment blue">
                    ...
                    <h2 class="ui header dividing blue">Démonstration vidéo
                        <noscript class="ui sub header">
                            <a style="color: red" href="https://vimeo.com/376631754">Cliquez pour voir la vidéo si JavaScript est désactivé.</a>
                        </noscript>
                    </h2>
                </div>
